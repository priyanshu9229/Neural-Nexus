...
import { Sparkles, ArrowRight, Bot, Zap, ShieldCheck, CheckCircle2, Cpu, Globe, Layers } from 'lucide-react';
    ...
    <div className="space-y-24 py-8">
      ...
      <section className="text-center space-y-8 max-w-4xl mx-auto pt-8">
        ...
        >
          ...
          <span>⚡ Powered by Autonomous Multi-Agent AI Engine</span>
        </motion.div>
        ...
        >
          ...
          <span className="gradient-text">Complete Content Campaign.</span>
        </motion.h1>
        ...
        >
          ...
          <Link
            href="/results"
            className="w-full sm:w-auto px-6 py-4 rounded-xl glass-panel-interactive text-gray-300 hover:text-white text-sm font-medium flex items-center justify-center gap-2 border border-white/10"
          >
            <Layers className="w-4 h-4 text-purple-400" />
            View Sample Campaign Package
          </Link>
        </motion.div>
      </section>
      ...
      <section className="glass-panel p-8 rounded-3xl max-w-5xl mx-auto space-y-6 border border-purple-500/30 bg-gradient-to-b from-purple-950/20 to-black/40">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-bold text-white">Engineered for Enterprise Speed, Quality & Control</h3>
            <p className="text-xs text-gray-400">Autonomous content creation without sacrificing strategic oversight.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-gray-300">
          <div className="space-y-2 p-4 rounded-xl bg-white/[0.02] border border-white/10">
            <h4 className="font-semibold text-sm text-purple-300 flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 text-purple-400" /> "Why I Made This Decision" Transparency
            </h4>
            <p className="leading-relaxed text-gray-400">
              Every agent discloses its internal rationale—explaining why specific hooks, statistical data points, or formatting styles were chosen.
            </p>
          </div>

          <div className="space-y-2 p-4 rounded-xl bg-white/[0.02] border border-white/10">
            <h4 className="font-semibold text-sm text-purple-300 flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 text-purple-400" /> Self-Critique & Continuous Polish Loop
            </h4>
            <p className="leading-relaxed text-gray-400">
              The Reviewer agent scores content readability and virality, instructing the Improver agent to fix weak points before final export.
            </p>
          </div>
        </div>
      </section>
